...
public class TC08_GeneralSetting_VerifyEnableOptionTheFlipHorizontalToVerticalOption extends TestBase {
    ...
    public void GeneralSetting_TheHeaderTextColorShouldBeChanged_WhenChangeTheHeaderTextColor() {
      ...
      String NewLayout=new GeneralSettingPage(driver)
                .checkCheckboxFlipHorizontalToVerticalAndPerformAction(true)
              .ClickSaveChanges()
              .GetValueOfLayout();

      Assert.assertNotEquals(InitLayout,NewLayout);
      Assert.assertEquals(NewLayout,"FlipMenuHorizontal");
