...
public class TC14_GeneralSetting_VerifyAvatarToggleWhenEnabled extends TestBase {
    ...
    @Test
    public void GeneralSetting_AvatarsShouldBeHidden_WhenToggleIsEnabled() {
        navigateToUrl();
        login.ValidLogin();
        ...
        new AdminstrationPage(driver)
                ...
                .checkCheckboxAvatarAndPerformAction(true) // Enable toggle
                .ClickSaveChanges();
       Boolean AvatarStatus= new AdminstrationPage(driver)
        ...
        Assert.assertFalse(AvatarStatus);
    }
