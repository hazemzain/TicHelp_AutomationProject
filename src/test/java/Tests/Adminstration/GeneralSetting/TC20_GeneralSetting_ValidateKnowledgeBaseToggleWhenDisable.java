...
public class TC20_GeneralSetting_ValidateKnowledgeBaseToggleWhenDisable extends TestBase {
    ...
    @Test
    public void GeneralSetting_KnowledgeBaseTabShouldBeAppear_WhenKnowledgeBaseCheckerIsDisable() {
        navigateToUrl();
        login.ValidLogin();
        ...
        String result=new AdminstrationPage(driver)
                ...
                ;
        Assert.assertEquals(result,"Knowledge base");
    }
}
