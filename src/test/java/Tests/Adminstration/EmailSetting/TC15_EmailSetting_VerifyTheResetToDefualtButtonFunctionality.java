...
public class TC15_EmailSetting_VerifyTheResetToDefualtButtonFunctionality extends TestBase {
    ...
    @Test
    public void EmailSetting_TheEmailTemplatesShouldBeReturnToDefault_WhenClickInResetToDefaultButton () throws InterruptedException {
        navigateToUrl();
        ...
        new AdminstrationPage(driver)
                .ClickAdminstrationButton()
                .ClickEmailSettingButton()
                .ClickResetTemplateButton()
                .AcceptAlert()
                .ClickSaveButton()
                .ClickAdminButton()
                .ClickLogoutButton();

        String ActualMessage2=new Login(driver)
                .ClickSubmitNewTicketButton()
                .EnterMail(TempEmail)
                .EnterNewSubject(Subject)
                .EnterNewDetails("This is for Test Automation HelpDisk")
        ...
        new TicketsPage(driver)
                ...
                .ClickInDeleteTicketButton();
        Thread.sleep(Duration.ofSeconds(20));
        Map<String, String> receivedEmail3= Helper.getFirstEmailDetailsUsingGmail();

        //Assert.assertTrue(receivedEmail2.get("Name").contains("admin"));

        System.out.println(receivedEmail3.get("Sender"));
        System.out.println(receivedEmail3.get("Subject"));
        Assert.assertTrue(receivedEmail3.get("Subject").startsWith("RE:"));
