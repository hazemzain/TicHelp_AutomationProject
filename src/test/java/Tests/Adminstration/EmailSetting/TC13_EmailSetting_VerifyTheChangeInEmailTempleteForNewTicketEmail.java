...
public class TC13_EmailSetting_VerifyTheChangeInEmailTempleteForNewTicketEmail extends TestBase {
    ...
    @Test
    public void EmailSetting_TheEmailTemplateShouldBeChanged_WhenChangeTheDefaultTemplate () throws InterruptedException {
        navigateToUrl();
        ...
        new AdminstrationPage(driver)
                ...
                .ChangeTheValueForSubjectEmailForNewTicketTemplete(ChangedSubject)
                .ClickSaveButton()
                .ClickAdminButton()
                .ClickLogoutButton();
        ...
        String ActualMessage=new Login(driver)
                ...
                .GetThanksMessage();
        Map<String, String> receivedEmail = Helper.getFirstEmailDetailsUsingGmail();
        System.out.println(receivedEmail.get("Sender"));
        System.out.println(receivedEmail.get("Subject"));
        Assert.assertTrue(receivedEmail.get("Subject").startsWith("SubjectNew:"));
