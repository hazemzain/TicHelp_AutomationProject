...
public class TC08_AutomationRules_VerifyThatUserCanNotCreateNewRuleWithoutFillAllRequeredFields extends TestBase {
    ...
    @Test
    public void AutomationRules_ValidationMessagesAppear_WhenSavingWithEmptyFields () {
        navigateToUrl();
        login.ValidLogin();
