...
public class TC10_AutomationRules_VerifyThatUserCanCreateNewRuleWithSingleCondition extends TestBase {
    ...
    @Test
    public void AutomationRules_TheRuleShouldBeCreated_WhenCreateNewRuleWithSingleCondition () {
        navigateToUrl();
        login.ValidLogin();
